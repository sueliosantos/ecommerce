...
class CartItem(models.Model):
    ...
    product = models.ForeignKey('catalogo.Product', verbose_name='Produto', on_delete=None)
...
class Order(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name='Usuário', on_delete=None)
...
class OrderItem(models.Model):
    order = models.ForeignKey(Order, verbose_name='Pedido', related_name='items', on_delete=None)
    product = models.ForeignKey('catalogo.Product', verbose_name='Produto', on_delete=None)
    quantity = models.PositiveIntegerField('Quantidade', default=1)
    price = models.DecimalField('Preço', decimal_places=2, max_digits=8)
